...
export default function RootLayout() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-base-200">
            ...
            >
              ...
              <li className="hover:bg-primary rounded-box">
                <Link to="/bookings" className="justify-between">
                  Bookings <span className="badge">New</span>
                </Link>
              </li>
              <li className="hover:bg-primary rounded-box">
              ...
              <li className="hover:bg-primary rounded-box">
                <button type="button" onClick={""} className="text-left">
                  Logout
                </button>
              </li>
            </ul>
      ...
      <footer className=" mt-auto footer bottom-0 sm:footer-horizontal bg-primary text-neutral-content p-10">
        <aside>
          <svg
            width="50"
            height="50"
